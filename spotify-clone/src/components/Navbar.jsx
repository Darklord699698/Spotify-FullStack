  ...
  return (
    ...
    <div className='flex items-center justify-between w-full font-semibold'>
        <div className='flex items-center gap-2'>
            <img onClick={()=>navigate(-1)} className='w-8 p-2 bg-black cursor-pointer rounded-2xl' src={assets.arrow_left} alt="" />
            <img onClick={()=>navigate(1)} className='w-8 p-2 bg-black cursor-pointer rounded-2xl' src={assets.arrow_right} alt="" />
        </div>
        <div className='flex items-center gap-4'>
            ...
            <p className='flex items-center justify-center text-black bg-purple-500 rounded-full w-7 h-7'>G</p>
        </div>
    </div>
